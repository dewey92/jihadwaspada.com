...
pubDate: 2019-08-16T13:15:43+02:00
...
image: "@assets/images/rope-climbing.jpg"
...
<Figure src="https://media.giphy.com/media/HIhwVDyNC6JOw/giphy-downsized.gif" alt="one on one" caption="One on One ini mah bro" width={60} />
...
```purescript {"error, Jakarta punya Indo, jangan maling!": 7-8} {"error, Indo sudah punya Jakarta": 10-11}
...
instance jakMalay :: OneToOne Jakarta Malaysia


instance berlinIndo :: OneToOne NewYork Indonesia
```
