...
<Figure src="https://media.giphy.com/media/42wMv7pMjAnH4uBn8G/giphy-downsized.gif" alt="yeah right" caption="" width={60} />
...
<Callout type="info">
  Untuk artikel yang lebih lengkap mengenai kind di Purescript, bisa mampir ke [Term, Type, dan Kind di Purescript](/blog/term-type-dan-kind-di-purescript).
</Callout>
...
<div class="aligned-@assets/images">
  <img src="@assets/images/purs-currency.png" alt="currency in purescript" />
  <img src="@assets/images/js-currency.png" alt="generated currency code" />
</div>
