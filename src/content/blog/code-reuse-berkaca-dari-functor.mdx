...
<Figure src="https://media.giphy.com/media/kBZBlLVlfECvOQAVno/200w_d.gif" alt="proud of myself" caption="tepuk tangan dulu" width={60} />
...
Sehingga jadilah sebuah fungsi generic baru untuk transformasi value di dalam suatu struktur data 🙂. Mari buatkan juga [Type Class]("/blog/kenalan-dulu-sama-type-class)-nya agar `t` dapat disubstitusi.
...
```purescript
transform incr [1, 2, 3, 4]
transform incr (Branch 1 (Leaf 2) (Leaf 3))
transform incr (Queue [1, 2, 3, 4])
```
