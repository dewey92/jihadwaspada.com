...
pubDate: 2019-08-28T01:00:48+02:00
...
```purescript "enterRoom (SProxy :: _ \"kamu\")"
...
<Figure src="https://media.giphy.com/media/7YeguV6Ia9lfO/giphy.gif" alt="yeah right" caption="squidward ganteng" width={60} />
...
Di artikel saya yang lalu tentang [HKT di Typescript](/blog/generic-di-atas-generic-higher-kinded-type), kita bisa menarik kesimpulan bahwa di bahasa-bahasa yang tidak memiliki klasifikasi type (kind) seperti Typescript, semua type variable diasumsikan memiliki kind `Type`. Walhasil konsep abstraksi seperti Functor dan Monad akan sulit diekspresikan oleh type system.
