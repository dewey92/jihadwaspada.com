...
console.log('Jihad: ', jihad.firstName) // undefined
console.log(userWithoutName === jihad) // true
```
...
console.log('no picture: ', userWithoutPicture.profile.picture) // undefined
console.log('jihad: ', jihad.profile.picture) // undefined
```
