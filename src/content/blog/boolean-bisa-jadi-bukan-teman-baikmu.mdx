...
const ContentWrapper = () => {
  const [hasReadMoreBtn, setHasReadMoreBtn] = useState(false)
...
<Figure src="@assets/images/flash-of-content.gif" alt="flash of content" caption="flash of content" width={60}/>
...
const ContentWrapper = () => {
  const [contentDisplay, setContentDisplay] = useState<ContentDisplay>('hidden')
  const contentRef = useRef(null)
...
Siapa yang tahu? Setidaknya, sudah [ada yang memodelkannya dengan union](https://hackage.haskell.org/package/ghc-prim-0.6.1/docs/src/GHC.Types.html#Bool).
...
<YouTube id="PLFl95c-IiU" title="Domain Modelling Made Functional" />
