...
pubDate: 2019-08-21T15:20:12+02:00
...
image: "@assets/images/row-houses.jpg"
...
<Figure src="https://media.giphy.com/media/12NUbkX6p4xOO4/giphy.gif" alt="one on one" caption="Compiler magic" width={60}/>
...
```purescript "\"age\" Int" "(name :: String, age :: Int)"
Cons "age" Int tail (name :: String, age :: Int)
      `head`                  `row`
